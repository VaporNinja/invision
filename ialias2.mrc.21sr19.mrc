...
show {
  if (($me ison $active) || ($query($active) != $null) || ($chat($right($active,-1)) != $null) || ($fserv($right($active,-1)) != $null)) {
    ...
    elseif ($1 == Time) { say $c(1) $+ 11,12Current Time $sv(6Time,$c(1) $+ $time(h:nntt)) $sv(6Day,$c(1) $date(dddd)) $sv(6Date,$c(1) $date(mmmm doo),$date(yyyy)) $sv(6TimeZone,$c(1) $tz)  $+ $ilogo }
...
fserve.ad.fitlogo {
  if ($r.set(Fserve,Verbose) == On) {
    if ($calc($len($c(2) $+ 3File Server Online $c(1)) + 3$len($fserve.ad.min.cps) + 3$len($fserve.ad.triggers) + 3$len($fserve.ad.ctcp) + 3$len($fserve.ad.sends) + $len($fserve.ad.queues) + $len($fserve.ad.access) + $len($fserve.ad.on) + $len($fserve.ad.record.cps) + $len($fserve.ad.bw) + $len($fserve.ad.filect) + $len($fserve.ad.aqt) + $len($fserve.ad.snagged) + $iif($r.set(Fserve,TwoLineAd) != On, $len($fserve.ad.note), 0)) >= 400) {
      return 
    }
    if ($calc($len($c(2) $+ 3File Server Online $c(1)) + 3$len($fserve.ad.min.cps) + 3$len($fserve.ad.triggers) + 3$len($fserve.ad.ctcp) + 3$len($fserve.ad.sends) + $len($fserve.ad.queues) + $len($fserve.ad.access) + $len($fserve.ad.on) + $len($fserve.ad.record.cps) + $len($fserve.ad.snagged) + $len($fserve.ad.bw) + $len($fserve.ad.aqt) + $len($fserve.ad.filect) + $iif($r.set(Fserve,TwoLineAd) != On, $len($fserve.ad.note), 0)) >= 350) {
      return $ilogo(X)
    }
    else { return $ilogo }
  }
  else {
    if ($calc($len($c(2) $+ 3File Server Online $c(1)) + 3$len($fserve.ad.min.cps) + 3$len($fserve.ad.triggers) + 3$len($fserve.ad.sends) + 3$len($fserve.ad.queues) + $len($fserve.ad.bw) + $len($fserve.ad.aqt) + $iif($r.set(Fserve,TwoLineAd) != On, $len($fserve.ad.note), 0)) >= 400) {
      return 
    }
    if ($calc($len($c(2) $+ 3File Server Online $c(1)) + 3$len($fserve.ad.min.cps) + 3$len($fserve.ad.triggers) + 3$len($fserve.ad.sends) + 3$len($fserve.ad.queues) + $len($fserve.ad.bw) + $len($fserve.ad.aqt) + $iif($r.set(Fserve,TwoLineAd) != On, $len($fserve.ad.note), 0)) >= 350) {
      return $ilogo(X)
    }
    else { return $ilogo }
...
fserve.ad.temp { 
  if ($r.set(Fserve,Verbose) == On) {
    return $c(2) $+ 3File Server Online $c(1) $+ $fserve.ad.triggers($1) $fserve.ad.ctcp $fserve.ad.min.cps $fserve.ad.sends $fserve.ad.queues $fserve.ad.access $fserve.ad.on $fserve.ad.record.cps $fserve.ad.snagged $fserve.ad.bw $fserve.ad.aqt $fserve.ad.filect $iif($r.set(Fserve,TwoLineAd) != On, $fserve.ad.note) $fserve.ad.fitlogo 
  }
  else {
    return $c(2) $+ 3File Server Online $c(1) $+ $fserve.ad.triggers($1) $fserve.ad.sends $fserve.ad.queues $fserve.ad.bw $fserve.ad.aqt $iif($r.set(Fserve,TwoLineAd) != On, $fserve.ad.note) $fserve.ad.fitlogo 
